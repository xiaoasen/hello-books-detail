...
Exercise 2.65.  Use the results of exercises [2.63](#Exercise2.63) and  [2.64](#Exercise2.64) to give ${\Theta(\log n)}$ implementations of `union-set` and `intersection-set` for sets implemented as (balanced) binary trees.41
